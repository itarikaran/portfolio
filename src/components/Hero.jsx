    ...
    <section id="home" className="relative overflow-hidden bg-white pt-8">
      <div className="mx-auto grid min-h-[calc(100vh-88px)] max-w-7xl items-center gap-16 px-4 py-10 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-16">
        ...
        >
          ...
          <p className="mt-8 text-base font-medium uppercase tracking-[0.28em] text-slate-500">Hello, I&apos;m</p>
          <h1 className="mt-4 text-5xl font-black tracking-tight text-slate-950 sm:text-6xl lg:text-7xl">ARI KARAN</h1>
          <div className="mt-5 flex min-h-10 flex-wrap items-center gap-3 text-2xl font-semibold text-blue-700 sm:text-3xl">
            <span>{displayText}</span>
            <span className="inline-block h-8 w-[2px] animate-pulse bg-blue-700" aria-hidden="true" />
          </div>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">
            Java Full Stack Developer building responsive React interfaces, Spring Boot REST APIs, and MySQL-backed workflows. I enjoy turning practical requirements into clean, connected web applications.
          </p>

          <div className="mt-6 flex flex-wrap gap-3 text-sm font-medium text-slate-600">
            <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm shadow-slate-200/40">
              <FiMapPin className="text-blue-700" />
              Tirunelveli, Tamil Nadu
            </span>
            <span className="inline-flex items-center rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm shadow-slate-200/40">
